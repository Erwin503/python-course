class Vehicle:
    ...
    def __init__(self, owner: str, model: str, color: str, engine_power: int):
        ...
        self.__model = model                   # Модель транспорта (неизменяемая)
        self.__engine_power = engine_power     # Мощность двигателя (неизменяемая)
        self.__color = color                   # Цвет автомобиля (неизменяемый)
...
class Sedan(Vehicle):
    __PASSENGERS_LIMIT = 5  # Максимальное количество пассажиров в седане
